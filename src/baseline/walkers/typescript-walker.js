...
// --------------------------------------------------
// Owns TypeScript Tree-sitter node recognition, naming
...
//
// The TypeScript and TSX grammars use public_field_definition
// rather than JavaScript's field_definition, so that node is
// not handled here.
// --------------------------------------------------
...
function visitTypeScriptNode(
    ...
    // CLASS DECLARATION / ABSTRACT CLASS
    if (
